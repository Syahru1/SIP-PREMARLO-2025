 ...
 <div class="sidebar-wrapper sidebar-theme">
    ...
    <div id="dismiss" class="d-lg-none"><i class="flaticon-cancel-12"></i></div>
        ...
        <ul class="list-unstyled menu-categories" id="accordionExample">
            ...
            <li class="menu">
                <a href="{{ route('admin.profile.index') }}" aria-expanded="true" class="dropdown-toggle">
                    <div>
            ...
            <li class="menu">
                <a href="{{ route('admin.kelolaDataLomba.index') }}" class="dropdown-toggle" aria-expanded="true">
                    <div>
            ...
            <li class="menu">
                <a href="{{ route('admin.verifikasiLomba.index') }}" class="dropdown-toggle" aria-expanded="true">
                    <div>
            ...
            <li class="menu">
                <a href="{{ route('admin.verifikasiPrestasi.index') }}" class="dropdown-toggle" aria-expanded="true">
                    <div>
            ...
            <li class="menu">
                <a href="{{ route('admin.kelolaPeriode.index') }}" class="dropdown-toggle" aria-expanded="true">
                    <div>
            ...
            <li class="menu">
                <a href="{{ route('admin.kelolaProdi.index') }}" class="dropdown-toggle" aria-expanded="true">
                    <div>
            ...
            <li class="menu">
                <a href="{{ route('admin.laporanAnalisisPrestasi.index') }}" class="dropdown-toggle" aria-expanded="true">
                    <div>
