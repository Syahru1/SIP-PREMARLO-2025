            ...
            <nav id="sidebar">
                ...
                <ul class="navbar-nav theme-brand flex-row  text-center">
                    ...
                    <li class="nav-item theme-text">
                        <a href="index.html" class="nav-link"> SIRLO </a>
                    </li>
                </ul>
                    ...
                    <li class="menu">
                        <a href="#submenu" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
                         ...
                         <ul class="collapse submenu list-unstyled" id="submenu" data-parent="#accordionExample">
                            ...
                            <li>
                                <a href="#sm2" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle"> Kelola Akun <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-chevron-right"><polyline points="9 18 15 12 9 6"></polyline></svg> </a>
                                <ul class="collapse list-unstyled sub-submenu" id="sm2" data-parent="#submenu2">
                                    <li>
                                        <a href="javascript:void(0);"> Akun Admin </a>
                                    </li>
                                    <li>
                                        <a href="javascript:void(0);"> Akun Dosen </a>
                                    </li>
                                    <li>
                                        <a href="javascript:void(0);"> Akun Mahasiswa </a>
                                    </li>
                                </ul>
                            </li>
                            <li>
                                <a href="javascript:void(0);"> Kelola Data Lomba </a>
                            </li>
                            <li>
                                <a href="javascript:void(0);"> Verfikasi Lomba </a>
                            </li>
                            <li>
                                <a href="javascript:void(0);"> Verifikasi Prestasi </a>
                            </li>
                            <li>
                                <a href="javascript:void(0);"> Kelola Periode </a>
                            </li>
                            <li>
                                <a href="javascript:void(0);"> Kelola Prodi </a>
                            </li>
                            <li>
                                <a href="javascript:void(0);"> Rekomendasi Lomba </a>
                            </li>
                            <li>
                                <a href="javascript:void(0);"> Laporan & Analisis Prestasi </a>
                            </li>
                        </ul>
