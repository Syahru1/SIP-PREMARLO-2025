		...
		<li class="sidebar-item active">
			<a href="#dashboards" data-toggle="collapse" class="sidebar-link">
                ...
                <li class="sidebar-item">
                        <a href="#kelolaPengguna" data-toggle="collapse" class="sidebar-link">
                                    <i class="align-middle" data-feather="user"></i><span class="align-middle">Kelola Data Pengguna</span>
                                </a>
                                <ul id="kelolaPengguna" class="sidebar-dropdown list-unstyled collapse" data-parent="#dashboards">
                                    <li class="sidebar-item"><a class="sidebar-link" href="data-admin.html">Data Admin</a></li>
                                    <li class="sidebar-item"><a class="sidebar-link" href="data-mahasiswa.html">Data Mahasiswa</a></li>
                                    <li class="sidebar-item"><a class="sidebar-link" href="tambah-pengguna.html">Data Dosen</a></li>
                                </ul>
                            </li>

                            <!-- Menu lainnya -->
							<li class="sidebar-item"><a class="sidebar-link" href="dashboard-analytics-1.html">Kelola Data Lomba</a></li>
							<li class="sidebar-item"><a class="sidebar-link" href="dashboard-e-commerce.html">Verifikasi Lomba</a></li>
							<li class="sidebar-item"><a class="sidebar-link" href="dashboard-social.html">Verifikasi Prestasi</a></li>
							<li class="sidebar-item"><a class="sidebar-link" href="dashboard-crypto.html">Kelola Data Periode</a></li>
                            <li class="sidebar-item"><a class="sidebar-link" href="dashboard-crypto.html">Kelola Data Prodi</a></li>
                            <li class="sidebar-item"><a class="sidebar-link" href="dashboard-crypto.html">Rekomendasi Lomba</a></li>
                            <li class="sidebar-item"><a class="sidebar-link" href="dashboard-crypto.html">Laporan & Analisis Prestasi</a></li>
						</ul>
					</li>
