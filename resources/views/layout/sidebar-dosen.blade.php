            ...
            <nav id="sidebar">
                ...
                <ul class="navbar-nav theme-brand flex-row  text-center">
                    ...
                    <li class="nav-item theme-text">
                        <a href="{{ url('dosen/beranda') }}" class="nav-link"> COMPQUEST </a>
                    </li>
                </ul>

                <ul class="list-unstyled menu-categories" id="accordionExample">
                    <li class="menu">
                        <a href="{{ url('dosen/beranda') }}" aria-expanded="false" class="dropdown-toggle">
                            <div class="">
                    ...
                    <li class="menu">
                        <a href="{{ url ('dosen/lomba') }}" aria-expanded="false" class="dropdown-toggle">
                            <div class="">
