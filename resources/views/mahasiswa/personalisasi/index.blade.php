...
<div class="container mt-5">
  <div class="p-4 rounded-4 shadow-sm bg-white border">
    ...
    <p class="mb-4 text-muted">Lengkapi informasi di bawah ini agar kami bisa merekomendasikan lomba yang paling sesuai dengan preferensi kamu.</p>

    <form id="formPersonal" method="POST" action="{{ route('personalisasi.submit') }}">
      @csrf
