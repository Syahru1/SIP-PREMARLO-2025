...
@section('content')
    <div class="container mt-5">
        <div class="p-4 rounded-4 shadow-sm bg-white border">
            <h2 class="text-secondary fw-bold mb-3">Personalisasi Minat Lomba</h2>
            <p class="mb-4 text-muted">Lengkapi informasi di bawah ini agar kami bisa merekomendasikan lomba yang paling
                sesuai dengan preferensi kamu.</p>
            ...
            @endif
            <form id="formPersonal" method="POST" action="{{ url('mahasiswa/preferensi/store') }}">
                @csrf
