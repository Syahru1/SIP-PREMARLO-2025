    ...
    <div class="card component-card_4">
        <div class="card-body">
            ...
            <ul class="nav nav-tabs mb-3" id="lineTab" role="tablist">
                <li class="nav-item">
                    <a class="nav-link active" id="underline-home-tab" data-toggle="tab" href="#underline-home" role="tab" aria-controls="underline-home" aria-selected="true">Rekomendasi Lomba</a>
                </li>
                <li class="nav-item">
