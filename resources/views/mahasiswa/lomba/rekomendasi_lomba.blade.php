    @if (empty($lombaList) || count($lombaList) === 0)
        <div class="form-row">
    ...
    @else
        @foreach ($lombaList as $lomba)
            <div class="mb-4 card component-card_9">
                <div class="form-row">
                    <div class="">
                        <img src="{{ asset('uploads/lomba/' . $lomba->gambar_lomba) }}" class="card-img-top"
                            alt="{{ $lomba->nama_lomba }}" style="width: 300px; height: 350px; " data-toggle="modal"
                        ...
                        <div class="modal fade" id="imageModal{{ $lomba->id_lomba }}" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body text-center">
                                        <img src="{{ asset('uploads/lomba/' . $lomba->gambar_lomba) }}"
                                            class="img-fluid" alt="{{ $lomba->nama_lomba }}">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col">
                        <div class="card-body">
                            ...
                            <a href="{{ url('mahasiswa/lomba/detail-lomba/' . $lomba->id_lomba) }}"
                                class="btn btn-primary">Detail</a>
                        </div>
                    </div>
                </div>
